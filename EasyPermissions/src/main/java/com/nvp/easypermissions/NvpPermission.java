...
public class NvpPermission {
    ...
    public static boolean isDenied(@NonNull Context context, @NonNull String permission) {
    ...
    @NonNull
    public static ArrayList<String> getDeniedPermissions(@NonNull Context context, @NonNull String... permissions) {
    ...
    public static boolean canRequestPermission(@NonNull Activity activity, @NonNull String... permissions) {
    ...
    private static boolean isFirstRequest(@NonNull Context context, @NonNull String[] permissions) {
        for (String permission : permissions) {
    ...
    private static boolean isFirstRequest(@NonNull Context context, String permission) {
    ...
    public static void startSettingActivityForResult(@NonNull Activity activity) {
        startSettingActivityForResult(activity, REQ_CODE_REQUEST_SETTING);
    }

    public static void startSettingActivityForResult(@NonNull Activity activity, int requestCode) {
    ...
    public static void startSettingActivityForResult(@NonNull Fragment fragment) {
        startSettingActivityForResult(fragment, REQ_CODE_REQUEST_SETTING);
    }

    public static void startSettingActivityForResult(@NonNull Fragment fragment, int requestCode) {
    ...
    private static void setFirstRequest(@NonNull Context context, String permission) {
